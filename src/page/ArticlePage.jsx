...
export const ArticlePage = ({ result, loading, setSearchValue }) => {
  ...
  const dummyContent = [
    ...
    },
    {
      ...
      text: "الاعتماد على التقنيات الحديثة يفتح آفاقاً جديدة للابتكار والتطوير. التوجه نحو الأتمتة واستخدام الذكاء الاصطناعي يسهم في خلق بيئة عمل أكثر مرونة وإنتاجية مع تقليل الأخطاء البشرية. الاعتماد على التقنيات الحديثة يفتح آفاقاً جديدة للابتكار والتطوير. التوجه نحو الأتمتة واستخدام الذكاء الاصطناعي يسهم في خلق بيئة عمل أكثر مرونة وإنتاجية مع تقليل الأخطاء البشرية. الاعتماد على التقنيات الحديثة يفتح آفاقاً جديدة للابتكار والتطوير. التوجه نحو الأتمتة واستخدام الذكاء الاصطناعي يسهم في خلق بيئة عمل أكثر مرونة وإنتاجية مع تقليل الأخطاء البشرية.",
      image:
